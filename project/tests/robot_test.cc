...
namespace csci3081 {
  ...
  class RobotTest : public ::testing::Test {
    public: 
      void SetUp() {
        ...
        details_1 = PicoJsonObjectRobot();
        
        details_2 = PicoJsonObjectRobot("robot",
                                   "robot2",
                                   "models/robot.glb",
                                   std::vector<float> {0.0, 0.0, 0.0},
                                   std::vector<float> {0.0, 0.0, 0.0},
        ...
        details_3 = PicoJsonObjectRobot("robot",
                                   "robot3",
                                   "models/robot.glb",
    ...
    protected:
      ...
      PicoJsonObjectRobot details_1;
      PicoJsonObjectRobot details_2;
      PicoJsonObjectRobot details_3;
  ...
  TEST_F(RobotTest, ConstructorTests) {
    Robot d1(details_1.obj);
    Robot d2(details_2.obj);
    Robot d3(details_3.obj);
    ...
    EXPECT_EQ(d1.GetName(), "robot") << "d1 - incorrect name initialization";
    EXPECT_EQ(d2.GetName(), "robot2") << "d2 - incorrect name initialization";
    EXPECT_EQ(d3.GetName(), "robot3") << "d3 - incorrect name initialization";
